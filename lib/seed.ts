...
export const players: Player[] = [
  { id: "p1", googleId: "google-lucas-siow", displayName: "Lucas Siow", email: "lucas.siow@example.com", profileImageUrl: "https://i.pravatar.cc/80?img=47", role: "admin" },
  { id: "p2", googleId: "google-david-ledvinka", displayName: "David Ledvinka", email: "david.ledvinka@example.com", profileImageUrl: "https://i.pravatar.cc/80?img=12", role: "organizer" },
  { id: "p3", googleId: "google-daniel-founier", displayName: "Daniel Founier", email: "daniel.founier@example.com", profileImageUrl: "https://i.pravatar.cc/80?img=33", role: "player" },
  { id: "p4", googleId: "google-jamie-naylor", displayName: "Jamie Naylor", email: "jamie.naylor@example.com", profileImageUrl: "https://i.pravatar.cc/80?img=5", role: "player" },
  { id: "p5", googleId: "google-tyler-longo", displayName: "Tyler Longo", email: "tyler.longo@example.com", profileImageUrl: "https://i.pravatar.cc/80?img=60", role: "player" },
  { id: "p6", googleId: "google-maksym-gryn", displayName: "Maksym Gryn", email: "maksym.gryn@example.com", profileImageUrl: "https://i.pravatar.cc/80?img=9", role: "player" },
  { id: "p7", googleId: "google-morgan-mclaughlin", displayName: "Morgan McLaughlin", email: "morgan.mclaughlin@example.com", profileImageUrl: "https://i.pravatar.cc/80?img=20", role: "player" },
  { id: "p8", googleId: "google-andrew-naylor", displayName: "Andrew Naylor", email: "andrew.naylor@example.com", profileImageUrl: "https://i.pravatar.cc/80?img=52", role: "player" },
  { id: "p9", googleId: "google-brian-liu", displayName: "Brian Liu", email: "brian.liu@example.com", profileImageUrl: "https://i.pravatar.cc/80?img=64", role: "player" },
  { id: "p10", googleId: "google-fadi-hirmiz", displayName: "Fadi Hirmiz", email: "fadi.hirmiz@example.com", profileImageUrl: "https://i.pravatar.cc/80?img=15", role: "player" },
  { id: "p11", googleId: "google-paul-dean", displayName: "Paul Dean", email: "paul.dean@example.com", profileImageUrl: "https://i.pravatar.cc/80?img=58", role: "player" },
  { id: "p12", googleId: "google-chris-harabas", displayName: "Chris Harabas", email: "chris.harabas@example.com", profileImageUrl: "https://i.pravatar.cc/80?img=3", role: "player" }
];
